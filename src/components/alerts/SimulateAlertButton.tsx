...
const SCENARIOS: Omit<AlertItem, "id" | "time" | "acknowledged">[] = [
  {
    ...
    location: "Tower A · Unit 12A · Living Room",
    unitId: "12A",
    aiConfidence: 91,
  ...
  },
  {
    ...
    location: "Tower A · Unit 12A · Bedroom",
    unitId: "12A",
    aiConfidence: 82,
  ...
  },
  {
    ...
    location: "Tower A · Unit 12A · Kitchen",
    unitId: "12A",
    aiConfidence: 88,
  ...
  },
  {
    ...
    location: "Tower A · Unit 12A · Entrance",
    unitId: "12A",
    aiConfidence: 74,
  ...
  },
  {
    ...
    kind: "power",
    title: "Power flicker",
    location: "Tower A · Floor 12 riser",
    unitId: "12A",
    aiConfidence: 70,
    aiNote: "Short voltage dip on the floor 12 circuit. Devices may have restarted.",
  },
];
          ...
          <div className="absolute right-0 top-11 z-20 w-64 overflow-hidden rounded-xl border border-border bg-surface shadow-2xl">
            {SCENARIOS.map((s) => (
              ...
              >
                ...
                <span className="text-[11px] capitalize text-tertiary">{s.severity} · unit 12A</span>
              </button>
            ))}
          </div>
        </>
